...
public class TC_DemoQA_100 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Sheet s = wb.getSheet("TC_DemoQA_100");
			...
			driver.findElement(By.xpath(s.getCell(8, 0).getContents())).click();
			Thread.sleep(2000);

			if (driver.getPageSource().contains(s.getCell(9, 0).getContents())) {
