...
public class TC_DemoQA_017 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Sheet s = wb.getSheet("TC_DemoQA_017");
			...
			if (driver.getPageSource().contains(s.getCell(4, 0).getContents())) {
			...
			driver.findElement(By.linkText(s.getCell(13, 0).getContents())).click();
			Thread.sleep(2000);

			if (driver.getTitle().contains(s.getCell(14, 0).getContents())) {
			...
			driver.findElement(By.xpath(s.getCell(17, 0).getContents())).click();
			Thread.sleep(3000);

			JavascriptExecutor js4 = (JavascriptExecutor) driver;
			js4.executeScript("window.scrollBy(0,500)", "");

			driver.findElement(By.id(s.getCell(18, 0).getContents())).click();
			Thread.sleep(3000);
			JavascriptExecutor js5 = (JavascriptExecutor) driver;
			js5.executeScript("window.scrollBy(0,400)", "");

			driver.findElement(By.linkText(s.getCell(19, 0).getContents())).click();
			Thread.sleep(2000);
			if (driver.getPageSource().contains(s.getCell(1, 0).getContents())) {
				System.out.println(s.getCell(20, 0).getContents());
			} else {
				System.out.println(s.getCell(21, 0).getContents());
			}
		} catch (Exception e) {
