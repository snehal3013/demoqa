...
public class TC_DemoQA_007 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Sheet s = wb.getSheet("TC_DemoQA_007");
			...
			boolean checkbox = driver.findElement(By.id(s.getCell(5, 0).getContents())).isEnabled();
			if (checkbox == true) {
				System.out.println(s.getCell(6, 0).getContents());
			} else {
				System.out.println(s.getCell(7, 0).getContents());
			}
			if (driver.getPageSource().contains(s.getCell(8, 0).getContents())) {
