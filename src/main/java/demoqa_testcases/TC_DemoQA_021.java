...
public class TC_DemoQA_021 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Sheet s = wb.getSheet("TC_DemoQA_021");
			...
			boolean radio = driver.findElement(By.id(s.getCell(4, 0).getContents())).isEnabled();
			if (radio == true) {
			...
			driver.findElement(By.id(s.getCell(7, 0).getContents()));
			Thread.sleep(6000);
			driver.findElement(By.id(s.getCell(8, 0).getContents()));
			Thread.sleep(6000);

			if (driver.findElement(By.id(s.getCell(9, 0).getContents())).isEnabled()) {
